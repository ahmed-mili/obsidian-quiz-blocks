...
export const FR_DASHBOARD: Record<keyof typeof EN_DASHBOARD, string> = {
	...
	"dashboard.quizzes.pauseConfirmTitle": "Suspendre les révisions ?",
	"dashboard.quizzes.pauseConfirmBody": "« {title} » n'apparaîtra plus dans le À faire de l'accueil jusqu'à sa reprise.",
	"dashboard.quizzes.pauseConfirmCta": "Oui",
	"dashboard.quizzes.archiveConfirmTitle": "Archiver ?",
	"dashboard.quizzes.archiveConfirmBody": "« {title} » rejoindra la section Archivés en bas de Mes quiz.",
	...
	"dashboard.quizzes.shareHint": "Aucune app ne peut joindre le fichier automatiquement — choisis-en une, elle s'ouvre avec le zip prêt à coller.",
	"dashboard.quizzes.shareSave": "Enregistrer le zip",
	"dashboard.quizzes.discordReady": "Zip copié — dans Discord : choisis une conversation, Ctrl+V puis Entrée.",
