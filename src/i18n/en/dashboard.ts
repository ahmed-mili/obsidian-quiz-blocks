...
export const EN_DASHBOARD = {
	...
	"dashboard.quizzes.shareHint": "No app can attach a file automatically — pick one, it opens with the zip ready to paste.",
	"dashboard.quizzes.shareSave": "Save zip",
	"dashboard.quizzes.discordReady": "Zip copied — in Discord: pick a chat, press Ctrl+V, then Enter.",
